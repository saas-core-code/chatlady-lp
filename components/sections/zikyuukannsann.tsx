  ...
  return (
    <section ref={sectionRef} className="py-24 bg-gradient-to-b from-white to-pink-50">
      <div className="container mx-auto px-4">
        ...
        >
          <h3 className="text-2xl text-gray-600 mb-8">時給換算</h3>
          <p className="text-7xl font-bold text-pink-600 mb-6 tracking-tight">
            ¥<CountUpNumber value={3500} />
          </p>
          <p className="text-lg text-gray-500">平均的な時給目安</p>
        </div>
      </div>
    </section>
  );
...
export default function ZikyuuKansan() {
  return (
